...
type NotificationEvent struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	EventId       string                 `protobuf:"bytes,1,opt,name=event_id,json=eventId,proto3" json:"event_id,omitempty"`       // Unique event ID for SSE (UUIDv7)
	EventType     string                 `protobuf:"bytes,2,opt,name=event_type,json=eventType,proto3" json:"event_type,omitempty"` // "notification", "heartbeat", "connection_established"
	...
	ConnectionId  string                 `protobuf:"bytes,5,opt,name=connection_id,json=connectionId,proto3" json:"connection_id,omitempty"` // Present on connection_established heartbeats for presence tracking
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type UpdatePresenceStatusRequest struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	Status            PresenceStatus         `protobuf:"varint,1,opt,name=status,proto3,enum=rpc.v1.PresenceStatus" json:"status,omitempty"`
	ActiveChannelId   string                 `protobuf:"bytes,2,opt,name=active_channel_id,json=activeChannelId,proto3" json:"active_channel_id,omitempty"` // Optional - null/empty when not viewing a channel
...
func (x *UpdatePresenceStatusRequest) GetActiveChannelId() string {
	if x != nil {
		return x.ActiveChannelId
	}
	return ""
...
func (x *UpdatePresenceStatusRequest) GetLastInteractionAt() *timestamppb.Timestamp {
	if x != nil {
...
func (x *UpdatePresenceStatusRequest) GetConnectionId() string {
	if x != nil {
		return x.ConnectionId
	}
	return ""
...
type UpdatePresenceStatusResponse struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	Status          PresenceStatus         `protobuf:"varint,1,opt,name=status,proto3,enum=rpc.v1.PresenceStatus" json:"status,omitempty"`
	ActiveChannelId string                 `protobuf:"bytes,2,opt,name=active_channel_id,json=activeChannelId,proto3" json:"active_channel_id,omitempty"`
...
func (x *UpdatePresenceStatusResponse) GetActiveChannelId() string {
	if x != nil {
		return x.ActiveChannelId
	}
	return ""
...
func (x *UpdatePresenceStatusResponse) GetUpdatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.UpdatedAt
	}
	return nil
...
func (x *UpdatePresenceStatusResponse) GetConnectionId() string {
	if x != nil {
		return x.ConnectionId
	}
	return ""
...
const file_rpc_v1_notification_proto_rawDesc = "" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x05R\x05value:\x028\x01\"\xea\x01\n" +
	"\x1bUpdatePresenceStatusRequest\x12.\n" +
	"\x06status\x18\x01 \x01(\x0e2\x16.rpc.v1.PresenceStatusR\x06status\x12*\n" +
	"\x11active_channel_id\x18\x02 \x01(\tR\x0factiveChannelId\x12J\n" +
	"\x13last_interaction_at\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\x11lastInteractionAt\x12#\n" +
	"\rconnection_id\x18\x04 \x01(\tR\fconnectionId\"\xda\x01\n" +
	"\x1cUpdatePresenceStatusResponse\x12.\n" +
	"\x06status\x18\x01 \x01(\x0e2\x16.rpc.v1.PresenceStatusR\x06status\x12*\n" +
	"\x11active_channel_id\x18\x02 \x01(\tR\x0factiveChannelId\x129\n" +
	"\n" +
	"updated_at\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt\x12#\n" +
	"\rconnection_id\x18\x04 \x01(\tR\fconnectionId\"=\n" +
	...
	"\x10preference_level\x18\x02 \x01(\x0e2#.rpc.v1.SubscriptionPreferenceLevelR\x0fpreferenceLevel*\xa7\x01\n" +
	...
	"\x17PRESENCE_STATUS_OFFLINE\x10\x04*\x8b\x01\n" +
	...
	"\x17VISIBILITY_MODE_OFFLINE\x10\x03*\xc8\x01\n" +
	...
	"#SUBSCRIPTION_PREFERENCE_LEVEL_MUTED\x10\x032\xbf\x13\n" +
	...
	"\n" +
	"notif.view\x12}\n" +
	"\x14UpdatePresenceStatus\x12#.rpc.v1.UpdatePresenceStatusRequest\x1a$.rpc.v1.UpdatePresenceStatusResponse\"\x1a\x82\xf9+\x16\n" +
...
var file_rpc_v1_notification_proto_goTypes = []any{
	...
	(SubscriptionPreferenceLevel)(0),                  // 3: rpc.v1.SubscriptionPreferenceLevel
